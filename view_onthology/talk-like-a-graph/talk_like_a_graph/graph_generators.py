...
def generate_graphs(
    ...
    if algorithm == "er":
        for i in range(number_of_graphs):
            ...
            number_of_nodes = random.choice(
                _NUMBER_OF_NODES_RANGE[graph_sizes[i]]
            )
        ...
        for i in range(number_of_graphs):
            ...
            p = np.random.uniform(
                size=(number_of_communities, number_of_communities)
            )
        ...
        for i in range(number_of_graphs):
            ...
            generated_graph = nx.scale_free_graph(
                number_of_nodes, seed=random_state
            )
